...
<ImageBackground source={imagenzinha} resizeMode="cover" style={{ height: '100%' }}>
                <View style={{ alignItems: 'center', height: 610 }}> 
                    ...
                    <Text style={{ fontSize: 30, color: 'white' }}>Formulário para cadastro</Text>
                    <TextInput style={{ borderWidth: 1, borderRadius: 20, alignItems: 'center', backgroundColor: 'white', borderColor: 'black', borderRadius: 20, margin: 7 }} onChangeText={(valor) => this.setState({ endereco: valor })} placeholder="Endereço do imovel" />
                    <TextInput style={{ borderWidth: 1, borderRadius: 20, alignItems: 'center', backgroundColor: 'white', borderColor: 'black', margin: 7 }} onChangeText={(valor) => this.setState({ finalidade: valor })} placeholder="Qual tipo de finalidade (venda ou aluguel)" />
                    <TextInput style={{ borderWidth: 1, borderRadius: 20, alignItems: 'center', backgroundColor: 'white', borderColor: 'black', margin: 7 }} onChangeText={(valor) => this.setState({ tipoimovel: valor })} placeholder="Qual tipo de imovel (casa, apartamento, comercio)" />
                    <TextInput style={{ borderWidth: 1, borderRadius: 20, alignItems: 'center', backgroundColor: 'white', borderColor: 'black', margin: 7 }} onChangeText={(valor) => this.setState({ fotoimovel: valor })} placeholder="Foto do imovel" />
                    <TextInput style={{ borderWidth: 1, borderRadius: 20, alignItems: 'center', backgroundColor: 'white', borderColor: 'black', margin: 7 }} onChangeText={(valor) => this.setState({ descricao: valor })} placeholder="Descricao do imovel" />
